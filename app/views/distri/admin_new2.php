...
<article class="module width_half">
    ...
    <header><h3 class="tabs_involved">Crear Admin edificio</h3>
        <ul class="tabs">
        ...
        <div class="module_content">
            ...
            <ul id="search_list" style="list-style-type: none;">
                ...
                while ($i < count($edificios)) {
                    ?>
                    <li>
                        <span width="6%"><input name="select[]" type="checkbox" id="select[]" value="<?= $edificios[$i]['id'] ?>" <?php if (!empty($edificios[$i]['admin_id'])) echo 'checked="checked"'; ?>></span>
